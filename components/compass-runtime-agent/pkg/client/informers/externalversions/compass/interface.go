...
import (
	v1alpha1 "github.com/kyma-project/application-connector-manager/components/compass-runtime-agent/pkg/client/informers/externalversions/compass/v1alpha1"
