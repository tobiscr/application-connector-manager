...
// GetConnectorCertSecuredClient provides a mock function with no fields
func (_m *ClientsProvider) GetConnectorCertSecuredClient() (connector.Client, error) {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for GetConnectorCertSecuredClient")
	}
...
func (_m *ClientsProvider) GetConnectorTokensClient(url string) (connector.Client, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetConnectorTokensClient")
	}
...
func (_m *ClientsProvider) GetDirectorClient(runtimeConfig config.RuntimeConfig) (director.DirectorClient, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GetDirectorClient")
	}
