...
- Your desired Namespace, cluster domain, and the names for your Function and APIRule exported as environment variables
  ...
  ```
- [Istio sidecar injection](https://github.com/kyma-project/kyma/blob/main/docs/01-overview/service-mesh/smsh-03-istio-sidecars-in-kyma.md) enabled in your Namespace
  ```bash
